            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center justify-center gap-2 mt-2">
                        <span className="text-3xl font-bold bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent font-baloo">
                            Level {newLevel}
                        </span>
                ...
                <motion.button
                    ...
                    onClick={onClose}
                    className="mt-4 px-6 py-2 bg-blue-500 text-white rounded-full font-baloo hover:bg-blue-600 transition-colors"
                >
                    Tiếp tục
                </motion.button>
            </motion.div>
