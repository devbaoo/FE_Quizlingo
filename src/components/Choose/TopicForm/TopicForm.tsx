      ...
      <main className="flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-8 px-4 sm:px-6 py-8 sm:py-0 h-auto sm:h-screen max-w-[988px] mx-auto">
        ...
        <div className="text-center mb-4 sm:mb-6 md:mb-8">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto font-baloo px-2">
            Hãy chọn những chủ đề bạn quan tâm để Quizlingo cá nhân hóa trải nghiệm học tập cho bạn!
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={`relative group cursor-pointer transition-all duration-300 transform hover:scale-105
                  ...
                  } rounded-2xl p-4 sm:p-6 border-2 ${isSelected ? "border-blue-500" : "border-transparent"}`}
              >
                <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4">
                  <div className={`p-3 sm:p-4 rounded-full ${isSelected ? "bg-white/20" : "bg-blue-100"}`}>
