                ...
                <div className="flex justify-between items-center py-2 px-3 border-b border-gray-200">
                    ...
                    {unreadCount > 0 && (
                        <Button
                            ...
                            className="text-xs hover:text-blue-600 px-0 font-baloo"
                        >
                            Đọc tất cả
                        </Button>
                    )}
                    ...
                    >
                        <div className="flex flex-col gap-1 p-3 relative">
                            ...
                            <div className={`flex flex-col ${!notification.isRead ? 'pl-3' : ''}`}>
                                <Typography.Text
                                    strong
                                    className={`text-sm ${!notification.isRead ? 'text-blue-600' : 'text-gray-800'} font-baloo`}
                                >
                                    {notification.title}
                                </Typography.Text>
                                <div className="relative">
                                    ...
                                    {shouldTruncate && (
                                        <Button
                                            type="link"
                                            size="small"
                                            className="px-0 h-5 text-xs text-blue-500 font-baloo"
