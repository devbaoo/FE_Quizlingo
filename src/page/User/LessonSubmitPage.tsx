...
const LessonSubmitPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4 font-baloo">
            <div className="max-w-3xl mx-auto">
                <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-4xl font-bold mb-4 font-baloo">Lesson Complete!</h1>
                        <div className="flex justify-center mb-6">
                            <div className="relative">
                                <div className="w-32 h-32 rounded-full bg-blue-100 flex items-center justify-center">
                                    <span className="text-4xl font-bold text-blue-500 font-baloo">{percentage}%</span>
                                </div>
                        ...
                        <p className="text-xl text-gray-600 font-baloo">
                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-green-50 p-4 rounded-xl">
                                <h3 className="font-semibold text-green-700 mb-2 font-baloo">Correct Answers</h3>
                                <p className="text-2xl font-bold text-green-600 font-baloo">{correctAnswers}</p>
                            </div>
                            <div className="bg-red-50 p-4 rounded-xl">
                                <h3 className="font-semibold text-red-700 mb-2 font-baloo">Incorrect Answers</h3>
                                <p className="text-2xl font-bold text-red-600 font-baloo">{totalQuestions - correctAnswers}</p>
                            </div>
                        </div>

                        <div className="bg-gray-50 p-6 rounded-xl">
                            <h3 className="font-semibold mb-4 font-baloo">Question Results</h3>
                    ...
                    <div className="mt-8 flex justify-center gap-4">
                        <button
                            onClick={handleExit}
                            className="px-6 py-3 bg-gray-200 rounded-xl hover:bg-gray-300 transition-colors font-baloo"
                        >
                            Exit Lesson
                        </button>
                        <button
                            onClick={handleRetry}
                            className={`px-6 py-3 rounded-xl transition-colors font-baloo ${userProfile?.lives === 0 ? 'bg-gray-300 text-gray-400 cursor-not-allowed' : 'bg-blue-500 text-white hover:bg-blue-600'}`}
