...
const PremiumBanner = ({ package: premiumPackage }: { package: ActivePackage }) => {
    ...
    return (
        <div className="w-full mb-8">
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 p-4 sm:p-6 shadow-lg">
                ...
                <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="flex items-center gap-3 sm:gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm sm:text-base text-blue-100">{premiumPackage.name}</p>
                        </div>
                    </div>
                            ...
                            <div className="flex flex-col items-center lg:items-start gap-4 sm:gap-6 lg:w-1/3">
                                <div className="relative group">
                                    <div
                                        ...
                                        className={`relative w-28 h-28 sm:w-32 sm:h-32 lg:w-36 lg:h-36 rounded-full border-4 border-blue-200 flex items-center justify-center overflow-hidden cursor-pointer transition-all duration-300 ${avatarUploading ? 'opacity-50' : 'hover:border-blue-400'} ${avatarUploading || isSpinning ? 'animate-spin' : ''}`}
                                    >
                                        {profile.avatar ? (
                                            <img
                                                src={profile.avatar}
                                            ...
                                            <FaPlus className="text-blue-400 text-2xl sm:text-3xl" />
                                        )}
                                    ...
                                    {profile.activePackage && (
                                        <div className="absolute -top-2 -right-2 transform rotate-12">
                                            <span className="inline-flex items-center gap-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-2 py-1 rounded-full text-sm font-bold shadow-lg">
                                                <FaCrown className="text-yellow-300" />
                                                <span>VIP</span>
                                            </span>
                                        </div>
                                    )}
                                    <div className="absolute -bottom-6 sm:-bottom-8 left-1/2 transform -translate-x-1/2 text-xs sm:text-sm text-blue-600 font-medium opacity-0 group-hover:opacity-100 transition-all duration-300">
                                        Nhấn để đổi ảnh
                                    </div>
                                </div>
                                <input
                            ...
                            <div className="lg:w-2/3">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                    <div className={`${cardColor} p-3 sm:p-4 flex flex-col items-center hover:shadow-md transition-shadow`}>
                                        <FaMedal className="text-blue-500 text-xl sm:text-2xl mb-1" />
                                    ...
                                    <div className={`${cardColor} p-3 sm:p-4 flex flex-col items-center hover:shadow-md transition-shadow`}>
                                        <TbVocabulary className="text-blue-500 text-xl sm:text-2xl mb-1" />
