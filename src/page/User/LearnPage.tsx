...
import { units, type Tile, type TileType, type Unit } from "@/utils/utils";

// Không dùng useBoundStore, chỉ dùng state cục bộ cho lessonsCompleted

// Trạng thái của mỗi tile
// (Bạn có thể thay đổi logic này nếu muốn lưu lessonsCompleted vào localStorage hoặc backend)
    ...
    return (
        ...
        >
            <header className="flex items-center justify-between gap-4 p-4">
                ...
                <a
                    href={`https://duolingo.com/guidebook/en/${unitNumber}`}
                    target="_blank"
