        ...
        <div className="px-8 py-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                {topics.map((topic, idx) => (
                    <div
                        key={topic._id}
                        className="relative group bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl shadow-xl p-6 cursor-pointer transform transition duration-300 hover:scale-105 hover:shadow-2xl hover:-translate-y-2 animate-fade-in-up"
                        style={{ animationDelay: `${idx * 80}ms` }}
                    >
                        <div className="flex flex-col items-center">
                            <div className="w-20 h-20 mb-4 rounded-full border-4 border-white shadow-lg group-hover:scale-110 transition-transform duration-300 bg-white flex items-center justify-center">
