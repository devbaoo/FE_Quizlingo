    ...
    <div className="flex flex-col min-h-screen bg-white text-gray-800 relative">
      ...
      <main className="flex flex-col items-center justify-center gap-8 px-4 sm:px-6 h-screen max-w-[988px] mx-auto">
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          />
          <div className="text-base bg-blue-100 text-blue-900 px-6 py-3 rounded-lg shadow font-baloo text-center">
        ...
        <div className="flex justify-center mt-8">
          <button
            ...
            disabled={isLoading}
            className="px-8 py-4 rounded-xl text-lg font-semibold font-baloo transition-all duration-300 transform hover:scale-105 bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Đến với bài học nào ^^
          </button>
        </div>
