                    ...
                    <div className="space-y-4">
                        ...
                        {isVerifying ? (
                            <div className="text-center">
                                ...
                                <p className="mt-4 text-gray-600 font-baloo">Đang xác thực email của bạn...</p>
                            </div>
                        ) : (
                            <div className="text-center">
                                {isSuccess ? (
                                    <div>
                                        ...
                                        <p className="mt-4 text-gray-700 font-baloo">{message}</p>
                                        <p className="mt-2 text-sm text-gray-500 font-baloo">Bạn sẽ được chuyển hướng đến trang chủ trong vài giây...</p>
                                    </div>
                                ) : (
                                    <div>
                                        <svg
